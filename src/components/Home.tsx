...
function Home() {
  ...
  return (
      ...
      <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
        ...
        <button className=" px-4 rounded-md bg-slate-200 hover:bg-slate-700 hover:text-white text-gray-800 border-gray-300 text-lg border shadow-sm ring-offset-2 mx-2 " onClick={() =>  {navigate(`/add`)}}> Add Product</button>
        <button className=" px-4 rounded-md bg-red-400 hover:bg-red-600 hover:text-yellow-white text-yellow-50 border-gray-300 text-lg border shadow-sm ring-offset-2 mx-2" onClick={() =>  {navigate(`/favourites`)}}> Show Favourites</button>
        </div>
      </div>
    </nav>
        {store.loading ? <h1>Loading Data</h1>
